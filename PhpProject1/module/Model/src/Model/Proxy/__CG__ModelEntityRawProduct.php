...
namespace Model\Proxy\__CG__\Model\Entity\Raw;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Product extends \Model\Entity\Raw\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Model\\Entity\\Raw\\Product' . "\0" . 'id', '' . "\0" . 'Model\\Entity\\Raw\\Product' . "\0" . 'slug', '' . "\0" . 'Model\\Entity\\Raw\\Product' . "\0" . 'title', '' . "\0" . 'Model\\Entity\\Raw\\Product' . "\0" . 'description', '' . "\0" . 'Model\\Entity\\Raw\\Product' . "\0" . 'price', '' . "\0" . 'Model\\Entity\\Raw\\Product' . "\0" . 'currency', '' . "\0" . 'Model\\Entity\\Raw\\Product' . "\0" . 'type');
        }

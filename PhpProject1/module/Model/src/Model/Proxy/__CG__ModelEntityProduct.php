 ...
 */
class Product extends \Model\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Model\\Entity\\Product' . "\0" . 'attachments');
        }
    ...
    public function setAttachments($products)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAttachments', array($products));

        return parent::setAttachments($products);
    }
    ...
    public function setAttachment(\Model\Entity\Attachment $product)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAttachment', array($product));

        return parent::setAttachment($product);
    }
